...
declare namespace Flex {
  interface Driver {
    ...
    filterTransferLogs(
      arg: Driver.FilterTransferLogsArg
    ): Promise<Meter.Transfer[]>;

    // vendor methods
    signTx(
      msg: Driver.SignTxArg,
      options: Driver.SignTxOption
    ): Promise<Driver.SignTxResult>;
    signCert(
