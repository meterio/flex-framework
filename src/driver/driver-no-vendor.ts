...
export class DriverNoVendor implements Flex.Driver {
    ...
    public getCandidates() {
        return this.cache.getCandidates(() =>
            this.httpGet(`staking/candidates`))
    }
    public getBuckets() {
        return this.cache.getBuckets(() =>
            this.httpGet(`staking/buckets`))
    }
    ...
    public getAuction(){
        return this.cache.getAuction(()=>
            this.httpGet(`auction/present` ))
    }
    public getAuctionSummary(){
        return this.cache.getAuctionSummary(()=>
