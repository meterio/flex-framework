...
function newTxSigningService(
  driver: Flex.Driver
): Flex.Vendor.TxSigningService {
  const opts: Flex.Driver.SignTxOption = {};
...
function newCertSigningService(
  driver: Flex.Driver
): Flex.Vendor.CertSigningService {
  const opts: Flex.Driver.SignCertOption = {};
...
const clauseScheme: V.Scheme<Flex.Vendor.TxMessage[number]> = {
